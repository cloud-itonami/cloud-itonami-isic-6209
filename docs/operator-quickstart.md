# Operator Quickstart — cloud-itonami-isic-6209

Shortest path from clone to a verified local dry-run for **ISIC 6209** (`cloud-itonami-isic-6209`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6209.git
